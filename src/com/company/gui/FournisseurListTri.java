 ...
 * @author dhafeur
 */
public class FournisseurListTri extends BaseForm{
       Button deleteBtn,updateBtn ; 
    public static Fournisseur currentforn = null;
    private Object FournisseurServices;
   
    public FournisseurListTri(Resources res ) {
        ...
        add(sp);
         */
        ArrayList<Fournisseur> rdvs = FournisseurServies.getInstance().TrierFournisseur();
