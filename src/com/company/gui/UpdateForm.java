...
public class UpdateForm extends BaseForm{
    ...
    public UpdateForm(Resources res ) {
      super(new BorderLayout());
        ...
        TextField nom = new TextField(MyApplication.forn.getNom(), "Nom", 20, TextField.EMAILADDR);
        TextField prenom = new TextField(MyApplication.forn.getPrenom(), "Prenom", 20, TextField.EMAILADDR);
        TextField email = new TextField(MyApplication.forn.getEmail(), "Email", 20, TextField.EMAILADDR);
        TextField tel = new TextField(String.valueOf(MyApplication.forn.getTel()), "Tel", 20, TextField.EMAILADDR);
...
start.setType(Display.PICKER_TYPE_DATE);
   ...
   try {
                ...
                if(nom.getText().equals("") || prenom.getText().equals("") || email.getText().equals("") || tel.getText().equals("") ) {
                    ...
                    Fournisseur fornn = new Fournisseur(
                    ...
                    System.out.println("data  fournisseur == "+fornn);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                    FournisseurServies.getInstance().updateFournisseur(fornn);
